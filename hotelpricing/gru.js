function visualizeGRU(data) {
  ...
  Plotly.newPlot("gruChart", [
    { x: dates, y: actual, mode: "lines", name: "Actual ADR", line: { color: "#1f77b4" } },
    { x: dates, y: predicted, mode: "lines", name: "Predicted ADR (GRU)", line: { color: "#ff7f0e" } }
  ], { title: "GRU Model Forecast: Actual vs Predicted ADR", xaxis: { title: "Date" }, yaxis: { title: "Average Daily Rate" } });
